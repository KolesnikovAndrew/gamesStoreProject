...
export const Product = ({ addEntry, id, product }) => {
  ...
  productFromAPI ? console.log("product is set") : loadGame();
          ...
          <div className={styles.product}>
            <div className={styles.gameinfo}>
              ...
              <div className={styles.gameInfoText}>
                ...
                <p>Publisher: {productFromAPI.publisher}</p>
                <p>Realease date: {productFromAPI.release_date}</p>
                <hr />
                <p>{productFromAPI.short_description}</p>
                <hr />
                <p>Genres: {productFromAPI.genre}</p>
                <p>
                  Platfroms:
            ...
            <div className={styles.aboutGame}>
              ...
              {about ? (
                <p>
                  ...
                  <br />
                  <hr />
                  Bibendum neque egestas congue quisque. Vitae sapien
                  pellentesque habitant morbi tristique senectus et. Magna ac
                  placerat vestibulum lectus mauris ultrices eros in cursus. Mi
                  eget mauris pharetra et ultrices. Aliquam malesuada bibendum
                  arcu vitae elementum curabitur vitae nunc sed. Magnis dis
                  parturient montes nascetur ridiculus mus.
                  <br />
                  <hr />
                  Egestas sed sed risus pretium quam vulputate. Duis at tellus
                  at urna condimentum mattis pellentesque. Vitae auctor eu augue
                  ut lectus arcu bibendum. Nisl purus in mollis nunc sed id
                  semper. Diam sit amet nisl suscipit. Dignissim suspendisse in
                  est ante in nibh mauris cursus mattis. Egestas erat imperdiet
                  sed euismod nisi. Nisl pretium fusce id velit ut tortor
                  pretium. Orci phasellus egestas tellus rutrum tellus
                  pellentesque eu.
                  <br />
                  <hr />
                  Sit amet risus nullam eget felis eget. Dolor morbi non arcu
                  risus quis. Dolor sed viverra ipsum nunc aliquet bibendum enim
                  facilisis. Pellentesque massa placerat duis ultricies.
                  Lobortis elementum nibh tellus molestie. Faucibus ornare
                  suspendisse sed nisi lacus sed. Et netus et malesuada fames ac
                  turpis egestas. Eget dolor morbi non arcu. Non odio euismod
                  lacinia at quis risus sed vulputate. Erat nam at lectus urna.
                  In nibh mauris cursus mattis molestie a iaculis. Turpis
